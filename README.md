...
## Interactive Timeline Chart for React with TypeScript.

### Forked from [gantt-task-react](https://github.com/MaTeMaTuK/gantt-task-react)

![example](https://user-images.githubusercontent.com/26743903/88215863-f35d5f00-cc64-11ea-81db-e829e6e9b5c8.png)

## [Live Demo (gantt-task-react)](https://matematuk.github.io/gantt-task-react/)

## Install

```
npm install @yoopknows/timeline

// or

yarn install @yoopknows/timeline
```

## How to use it

```javascript
import { Gantt, Task, EventOption, StylingOption, ViewMode, DisplayOption } from '@yoopknows/timeline';
